define(function(require, exports, module) {
  ...
  /**
   * For when elements come into the DOM. The callback triggers immediately
   * after the element enters the DOM. It is called with the element as the
   * only argument.
   */
   ...
   * before the element leaves the DOM. It is called with the element as the
   * only argument.
   */
   ...
   * new element enters the DOM, and before the old element leaves. It is
   * called with old and new elements as arguments, in that order.
   */
   ...
   * after the textContent has changed in the DOM. It is called with the
   * element, the old value, and current value.
   */
